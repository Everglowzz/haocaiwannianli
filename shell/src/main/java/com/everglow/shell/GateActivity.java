...
//        String url = "http://appid.aigoodies.com/getAppConfig.php?appid=appidcsh5";
        String url = "http://appid.aigoodies.com/getAppConfig.php?appid="+Api.appid;
...
//                    if (true) {
                    if (isSuccess && !TextUtils.isEmpty(getShowWeb) && getShowWeb.equals("1") && !TextUtils.isEmpty(url)) {
                        Intent intent = new Intent(GateActivity.this, ShellWelcomeActivity.class);
...
//                    ARouter.getInstance().build("/weather/activity").navigation();
                    startActivity(new Intent(GateActivity.this, ShellShowActivity.class));
                    finish();
                }
            }
        }).start();
